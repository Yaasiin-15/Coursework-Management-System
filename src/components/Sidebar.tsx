...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div className={`bg-white dark:bg-gray-800 shadow-lg h-screen fixed left-0 top-0 z-40 transition-all duration-300 ${isCollapsed ? 'w-16 -translate-x-full lg:translate-x-0' : 'w-64 translate-x-0'
        }`}>
        {/* Header */}
